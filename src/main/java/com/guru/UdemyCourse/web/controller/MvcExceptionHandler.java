...
@ControllerAdvice // esta etiqueta le dice como tal a Spring que es un
// ExceptionHandler y no hace falta hacer alguna referencia a este,
// con la etiqueta ExceptionHandler por default todos los Controllers la tendrán
